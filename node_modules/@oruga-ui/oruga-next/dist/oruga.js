...
(function (global, factory) {
    ...
    exports.ONotification = script$m;
    exports.OPagination = script$p;
    exports.OPaginationButton = script$o;
    exports.ORadio = script$q;
    exports.OSelect = script$c;
    exports.OSidebar = script$s;
    exports.OSkeleton = script$r;
    exports.OSlider = script$w;
    exports.OSliderTick = script$v;
    exports.OStepItem = script$y;
    exports.OSteps = script$x;
    exports.OSwitch = script$z;
    exports.OTabItem = script$F;
    exports.OTable = script$D;
    exports.OTableColumn = script$B;
    exports.OTabs = script$E;
    exports.OTimepicker = script$h;
    exports.OTooltip = script$t;
    exports.OUpload = script$G;
