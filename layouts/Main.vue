...
const navigation = reactive([
  ...
  { name: "Sales", icon: "layer-plus", path: "/parcel-merging", current: false },
  { name: "About", icon: "coin-vertical", path: "/staking", current: false },
  { name: "Events", icon: "arrows-repeat", path: "/swap", current: false },
  { name: "Contact", icon: "fa-user-secret", path: "/dao" },
])
